...
export default function HomePage() {
  ...
  return (
    <main className="page-transition bg-[color:var(--surface-2)] text-[color:var(--foreground)]">
      <section
        ref={heroRef}
        className="relative overflow-hidden bg-[radial-gradient(circle_at_20%_10%,rgba(59,130,246,0.3),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(34,211,238,0.3),transparent_30%),linear-gradient(160deg,#070b1a_0%,#0a1737_50%,#111f44_100%)] px-4 pb-14 pt-16 sm:px-8"
      >
        ...
        <div className="relative mx-auto w-full max-w-6xl">
          <div className="mx-auto mt-16 max-w-3xl text-center">
            <p
              className="animate-fade-in-up text-sm font-semibold uppercase tracking-[0.28em] text-cyan-300"
            ...
            >
              YOUR{" "}
              <TypingAnimation
                words={["PLATFORM", "SOLUTION", "SYSTEM", "TOOL", "APP", "HUB"]}
              />{" "}
              FOR SEAMLESS EVENTS
            </h1>
            <p
              className="mx-auto mt-4 animate-fade-in-up max-w-xl text-sm text-white/80 sm:text-base"
              style={{ animationDelay: "300ms" }}
            >
              The modern way to manage registrations, gate scanning, and
              attendee flow without stress.
            </p>
            <div
      ...
      <section className="px-4 py-16 sm:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2
            className="animate-fade-in-up mt-4 text-3xl font-black leading-tight sm:text-4xl"
            style={{ animationDelay: "100ms" }}
          >
            More than just software. We are innovators with years of experience.
          </h2>
          <p
            className="animate-fade-in-up mx-auto mt-4 max-w-3xl text-sm leading-relaxed text-slate-600 sm:text-base"
            style={{ animationDelay: "200ms" }}
          >
            Access Pro gives teams one connected system for invitations,
            attendance tracking, and day-of-event execution. Build better events
            with fast setup and smooth on-site operations.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl gap-4 md:grid-cols-3">
          <div className="animate-fade-in-up rounded-2xl bg-linear-to-br from-sky-200 to-cyan-100 p-6 hover:shadow-lg transition-all duration-300">
            ...
            <p className="mt-3 text-sm text-slate-700">
              Keep workflows clear and focused. No bloated setup, no complex
              handoffs.
            </p>
          </div>
          <div
            className="animate-fade-in-up rounded-2xl border border-slate-200 bg-white p-4 md:col-span-2 hover:shadow-lg transition-all duration-300"
            style={{ animationDelay: "100ms" }}
          >
            <img
        ...
        <div className="mx-auto grid max-w-6xl gap-4 md:grid-cols-5">
          <div className="animate-fade-in-up rounded-2xl bg-linear-to-br from-cyan-400 to-sky-500 p-6 text-white md:col-span-2 hover:shadow-lg transition-all duration-300">
            <p className="text-3xl font-black leading-tight">
              Your Events Can Cut Across
            </p>
          </div>
          <div
            className="animate-fade-in-up rounded-2xl bg-slate-900 p-5 text-sm font-semibold text-cyan-200 hover:bg-slate-800 hover:scale-105 transition-all duration-300"
            style={{ animationDelay: "50ms" }}
          >
            Conferences & Exhibitions
          </div>
          <div
            className="animate-fade-in-up rounded-2xl bg-blue-900 p-5 text-sm font-semibold text-cyan-200 hover:bg-blue-800 hover:scale-105 transition-all duration-300"
            style={{ animationDelay: "100ms" }}
          >
            Annual General Meetings
          </div>
          <div
            className="animate-fade-in-up rounded-2xl bg-slate-800 p-5 text-sm font-semibold text-cyan-200 hover:bg-slate-700 hover:scale-105 transition-all duration-300"
            style={{ animationDelay: "150ms" }}
          >
            Festivals & Concerts
          </div>
          <div
            className="animate-fade-in-up rounded-2xl bg-slate-700 p-5 text-sm font-semibold text-cyan-200 hover:bg-slate-600 hover:scale-105 transition-all duration-300"
            style={{ animationDelay: "200ms" }}
          >
            Government Summits
          </div>
          <div
            className="animate-fade-in-up rounded-2xl bg-slate-600 p-5 text-sm font-semibold text-cyan-200 hover:bg-slate-500 hover:scale-105 transition-all duration-300"
            style={{ animationDelay: "250ms" }}
          >
            Trade Shows
          </div>
          <div
            className="animate-fade-in-up rounded-2xl bg-white p-6 md:col-span-2 hover:shadow-lg transition-all duration-300"
            style={{ animationDelay: "300ms" }}
          >
            <h3 className="text-xl font-black">
              Versatile. Built for any event.
            </h3>
            <p className="mt-2 text-sm text-slate-600">
              Whether you run invite-only forums or public experiences, Access
              Pro scales cleanly and keeps your team in sync.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 text-center">
            ...
            <h2
              ...
              style={{ animationDelay: "100ms" }}
            >
              Powerful tools to make every event a success.
            </h2>
          </div>
      ...
      <section className="px-4 py-16 sm:px-8">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
              ...
              <ul className="mt-4 space-y-3 text-sm text-slate-700">
                ...
                <li className="flex gap-2 hover:translate-x-1 transition-transform duration-200">
                  <CheckCircle2
                    ...
                    className="mt-0.5 text-sky-600 shrink-0"
                  />
                  Publish branded invites and track RSVPs instantly.
                </li>
                <li className="flex gap-2 hover:translate-x-1 transition-transform duration-200">
                  <CheckCircle2
                    size={16}
                    className="mt-0.5 text-sky-600 shrink-0"
                  />
                  Coordinate teams with one shared operations dashboard.
                </li>
              </ul>
            </div>
            <img
            ...
            />
            <div
              className="animate-fade-in-up rounded-2xl bg-white p-6 hover:shadow-lg transition-all duration-300"
              style={{ animationDelay: "200ms" }}
            >
              <h3 className="text-xl font-black">
              ...
              <ul className="mt-4 space-y-3 text-sm text-slate-700">
                <li className="flex gap-2 hover:translate-x-1 transition-transform duration-200">
                  <CheckCircle2
                    ...
                    className="mt-0.5 text-sky-600 shrink-0"
                  />
                  Fast QR scanning to reduce gate congestion.
                </li>
                <li className="flex gap-2 hover:translate-x-1 transition-transform duration-200">
                  <CheckCircle2
                    size={16}
                    className="mt-0.5 text-sky-600 shrink-0"
                  />
                  Live communication for updates and announcements.
                </li>
                <li className="flex gap-2 hover:translate-x-1 transition-transform duration-200">
                  <CheckCircle2
                    size={16}
                    className="mt-0.5 text-sky-600 shrink-0"
                  />
                  Real-time check-in progress and attendance tracking.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            <div>
              ...
              <p
                ...
                style={{ animationDelay: "150ms" }}
              >
                Everything happens inside your organization workspace: create
                events, manage guests, and run live QR check-ins with real-time
                updates.
              </p>
              <div
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {[
                {
                  title: "Create org",
                  text: "Set up your workspace once.",
                  icon: Sparkles,
                },
                {
                  title: "Create event",
                  text: "Add name, date, location.",
                  icon: Users,
                },
                {
                  title: "Add guests",
                  text: "Upload lists or add manually.",
                  icon: Zap,
                },
                {
                  title: "Scan live",
                  text: "Fast gate operations with QR.",
                  icon: QrCode,
                },
              ].map((card, idx) => (
                <AnimatedCard
      ...
      <section className="bg-[#121e4c] px-4 py-16 text-white sm:px-8">
        <div className="mx-auto max-w-4xl text-center">
          <p className="animate-fade-in-up text-xs font-bold uppercase tracking-[0.24em] text-cyan-300">
            Contact Us Today
          </p>
          <h2
            className="animate-fade-in-up mt-4 text-3xl font-black sm:text-4xl"
            style={{ animationDelay: "100ms" }}
          >
            Curious if Access Pro is right for your event?
          </h2>
          <p
            className="animate-fade-in-up mx-auto mt-4 max-w-2xl text-sm text-white/80 sm:text-base"
            style={{ animationDelay: "200ms" }}
          >
            Speak with our team to discuss your event type, attendee volume, and
            workflow goals.
          </p>
          <div
          ...
          >
            <Link
              href="/contact"
              className="btn-primary rounded-full bg-white px-6 py-3 text-sm font-semibold text-slate-900 hover:bg-cyan-50 hover:shadow-lg"
            >
              Book a free consultation
            </Link>
            <Link
              href="/sign-in"
              className="btn-primary rounded-full border border-cyan-300 px-6 py-3 text-sm font-semibold text-cyan-200 hover:bg-cyan-300/10 hover:shadow-lg"
            >
              Login
            </Link>
          </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-2">
          <div>
            ...
            <p
              ...
              style={{ animationDelay: "150ms" }}
            >
              Here are common questions event organizers ask before launch day.
            </p>
            <Link
              href="/contact"
              className="btn-primary animate-fade-in-up mt-5 inline-block rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white hover:bg-slate-800 hover:shadow-lg"
              style={{ animationDelay: "200ms" }}
            >
              Contact us
            </Link>
          ...
          <div className="space-y-3">
            {[
              ...
              >
                <summary className="text-sm font-semibold text-slate-800 group-open:text-cyan-600 transition-colors duration-200">
                  {q}
                </summary>
                <p className="mt-2 text-sm text-slate-600">
                  Access Pro is designed for flexible events, with configurable
                  flows for registration, check-in, and reporting.
                </p>
              </details>
            ))}
          </div>
