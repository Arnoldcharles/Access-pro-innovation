...
import { Mail, PhoneCall, MapPin, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans antialiased">
      <div className="max-w-[1100px] mx-auto px-6 sm:px-10 lg:px-16 py-12">
        ...
        <motion.header initial="hidden" animate="show" variants={stagger} className="mb-12">
        ...
        <motion.div initial="hidden" animate="show" variants={stagger} className="grid lg:grid-cols-[1.2fr,0.8fr] gap-10">
          <motion.form variants={fadeUp} className="p-8 bg-white border border-slate-200 rounded-[2rem] space-y-5 shadow-sm">
            <div className="grid sm:grid-cols-2 gap-4">
              <input className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm" placeholder="First name" />
              <input className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm" placeholder="Last name" />
            </div>
            <input className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm" placeholder="Work email" />
            <input className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm" placeholder="Event size (approx.)" />
            <textarea className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm min-h-[140px]" placeholder="Tell us about your event" />
